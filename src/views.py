...
class HomeView(QWidget):
    ...
    def __init__(self, parent: QWidget = None):
        ...
        self.user_button = QPushButton("User Name", self.frame)
        ...
        self.employee_button = QPushButton(self.frame)
